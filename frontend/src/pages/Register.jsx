...
const Register = () => {
    ...
    const { bodyType, scores, login } = useContext(UserContext);
    const [formData, setFormData] = useState({
        name: '',
        email: '',
        password: '',
        bodyType: bodyType || null,
        scores: scores || { vata: 0, pitta: 0, kapha: 0 }
    });
            ...
            <div className="max-w-md w-full space-y-8 bg-white p-10 rounded-3xl border border-gray-100 shadow-xl">
                <div>
                    ...
                    <p className="mt-2 text-center text-sm text-gray-500">
                        Unlock your personalized ayurvedic lifestyle
                    </p>
                </div>
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div className="text-center">
                        <Link to="/login" className="text-sm font-bold text-indigo-600 hover:text-indigo-500 transition-colors">
